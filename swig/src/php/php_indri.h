...
/*If you declare any globals in php_indri.h uncomment this:
ZEND_BEGIN_MODULE_GLOBALS(indri)
ZEND_END_MODULE_GLOBALS(indri)
*/
#ifdef ZTS
#define INDRI_D  zend_indri_globals *indri_globals
#define INDRI_DC  , INDRI_D
#define INDRI_C  indri_globals
#define INDRI_CC  , INDRI_C
#define INDRI_SG(v)  (indri_globals->v)
#define INDRI_FETCH()  zend_indri_globals *indri_globals = ts_resource(indri_globals_id)
#else
#define INDRI_D
#define INDRI_DC
#define INDRI_C
