...
#define SWIGTYPE_p_std__vectorTindri__api__ScoredExtentResult_t swig_types[8]
#define SWIGTYPE_p_std__vectorTlemur__api__DOCID_T_t swig_types[9]
...
static zend_function_entry QueryAnnotationNode_functions[] = {
 ...
 ZEND_NAMED_FE(delete_queryannotationnode,_wrap_delete_QueryAnnotationNode, NULL)
   { NULL, NULL, NULL}
};
...
static swig_type_info _swigt__p_indri__api__ParsedDocument = {"_p_indri__api__ParsedDocument", "indri::api::ParsedDocument *", 0, 0, 0};
static swig_type_info _swigt__p_indri__api__QueryAnnotation = {"_p_indri__api__QueryAnnotation", "indri::api::QueryAnnotation *", 0, 0, 0};
static swig_type_info _swigt__p_indri__api__QueryAnnotationNode = {"_p_indri__api__QueryAnnotationNode", "indri::api::QueryAnnotationNode *", 0, 0, 0};
static swig_type_info _swigt__p_indri__api__QueryEnvironment = {"_p_indri__api__QueryEnvironment", "indri::api::QueryEnvironment *", 0, 0, 0};
static swig_type_info _swigt__p_indri__api__ScoredExtentResult = {"_p_indri__api__ScoredExtentResult", "indri::api::ScoredExtentResult *", 0, 0, 0};
static swig_type_info _swigt__p_indri__parse__TermExtent = {"_p_indri__parse__TermExtent", "indri::parse::TermExtent *", 0, 0, 0};
static swig_type_info _swigt__p_long_long = {"_p_long_long", "long long *|UINT64 *", 0, 0, 0};
static swig_type_info _swigt__p_std__string = {"_p_std__string", "std::string *", 0, 0, 0};
static swig_type_info _swigt__p_std__vectorTindri__api__ScoredExtentResult_t = {"_p_std__vectorTindri__api__ScoredExtentResult_t", "std::vector<indri::api::ScoredExtentResult > *", 0, 0, 0};
static swig_type_info _swigt__p_std__vectorTlemur__api__DOCID_T_t = {"_p_std__vectorTlemur__api__DOCID_T_t", "std::vector<lemur::api::DOCID_T > *", 0, 0, 0};
...
static int le_swig__p_long_long=0; /* handle for TermExtent */
...
static int le_swig__p_std__string=0; /* handle for QueryAnnotationNode */
...
static int _wrap_TermExtent_begin_set(zend_property_reference *property_reference, pval *value) {
    ...
    {
        /*@/usr/ind1/tmp2/dfisher/ciir/swig-linux/share/swig/1.3.27/php4/utils.i,4,CONVERT_INT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_delete_QueryAnnotationNode) {
    ...
    {
        /* typemap(in) SWIGTYPE * */
        if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_indri__api__QueryAnnotationNode, 0) < 0) {
            SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of delete_QueryAnnotationNode. Expected SWIGTYPE_p_indri__api__QueryAnnotationNode");
        }
    }
    delete arg1;
...
ZEND_NAMED_FUNCTION(_wrap_QueryEnvironment_addServer) {
    ...
    }
    {
        ...
        temp2 = std::string(Z_STRVAL_PP(args[0]));
        arg2 = &temp2;
    }
...
ZEND_NAMED_FUNCTION(_wrap_QueryEnvironment_documentMetadatadocids) {
    ...
    }
    {
        ...
        temp3 = std::string(Z_STRVAL_PP(args[1]));
        arg3 = &temp3;
    }
    {
        try {
