...
JNIEXPORT jdouble JNICALL Java_edu_umass_cs_indri_indriJNI_QueryEnvironment_1expressionCount_1_1SWIG_10(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jstring jarg3) {
  jdouble jresult = 0 ;
  indri::api::QueryEnvironment *arg1 = (indri::api::QueryEnvironment *) 0 ;
  std::string *arg2 = 0 ;
  std::string *arg3 = 0 ;
...
JNIEXPORT jdouble JNICALL Java_edu_umass_cs_indri_indriJNI_QueryEnvironment_1expressionCount_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2) {
  jdouble jresult = 0 ;
  indri::api::QueryEnvironment *arg1 = (indri::api::QueryEnvironment *) 0 ;
  std::string *arg2 = 0 ;
  double result;
...
JNIEXPORT jobjectArray JNICALL Java_edu_umass_cs_indri_indriJNI_QueryEnvironment_1expressionList_1_1SWIG_10(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jstring jarg3) {
  jobjectArray jresult = 0 ;
  indri::api::QueryEnvironment *arg1 = (indri::api::QueryEnvironment *) 0 ;
  std::string *arg2 = 0 ;
  std::string *arg3 = 0 ;
...
JNIEXPORT jobjectArray JNICALL Java_edu_umass_cs_indri_indriJNI_QueryEnvironment_1expressionList_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2) {
  jobjectArray jresult = 0 ;
  indri::api::QueryEnvironment *arg1 = (indri::api::QueryEnvironment *) 0 ;
  std::string *arg2 = 0 ;
  std::vector<indri::api::ScoredExtentResult > result;
...
JNIEXPORT void JNICALL Java_edu_umass_cs_indri_indriJNI_IndexStatus_1director_1connect(JNIEnv *jenv, jclass jcls, jobject jself, jlong objarg, jboolean jswig_mem_own, jboolean jweak_global) {
...
JNIEXPORT void JNICALL Java_edu_umass_cs_indri_indriJNI_IndexStatus_1change_1ownership(JNIEnv *jenv, jclass jcls, jobject jself, jlong objarg, jboolean jtake_or_release) {
  indri::api::IndexStatus *obj = *((indri::api::IndexStatus **)&objarg);
  SwigDirector_IndexStatus *director = dynamic_cast<SwigDirector_IndexStatus *>(obj);
  (void)jcls;
  if (director) {
...
JNIEXPORT void JNICALL Java_edu_umass_cs_indri_indriJNI_delete_1QueryExpander(JNIEnv *jenv, jclass jcls, jlong jarg1) {
...
JNIEXPORT jobjectArray JNICALL Java_edu_umass_cs_indri_indriJNI_QueryExpander_1runExpandedQuery_1_1SWIG_10(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jint jarg3, jboolean jarg4) {
  jobjectArray jresult = 0 ;
  indri::query::QueryExpander *arg1 = (indri::query::QueryExpander *) 0 ;
  std::string arg2 ;
  int arg3 ;
...
JNIEXPORT jobjectArray JNICALL Java_edu_umass_cs_indri_indriJNI_QueryExpander_1runExpandedQuery_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jint jarg3) {
  jobjectArray jresult = 0 ;
  indri::query::QueryExpander *arg1 = (indri::query::QueryExpander *) 0 ;
  std::string arg2 ;
  int arg3 ;
...
JNIEXPORT jstring JNICALL Java_edu_umass_cs_indri_indriJNI_QueryExpander_1expand(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jobjectArray jarg3) {
  jstring jresult = 0 ;
  indri::query::QueryExpander *arg1 = (indri::query::QueryExpander *) 0 ;
  std::string arg2 ;
...
JNIEXPORT jlong JNICALL Java_edu_umass_cs_indri_indriJNI_new_1RMExpander(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg2) {
  jlong jresult = 0 ;
  indri::api::QueryEnvironment *arg1 = (indri::api::QueryEnvironment *) 0 ;
...
JNIEXPORT jstring JNICALL Java_edu_umass_cs_indri_indriJNI_RMExpander_1expand(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jobjectArray jarg3) {
  jstring jresult = 0 ;
...
JNIEXPORT void JNICALL Java_edu_umass_cs_indri_indriJNI_delete_1RMExpander(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  indri::query::RMExpander *arg1 = (indri::query::RMExpander *) 0 ;
...
JNIEXPORT jlong JNICALL Java_edu_umass_cs_indri_indriJNI_new_1PonteExpander(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg2) {
  jlong jresult = 0 ;
  indri::api::QueryEnvironment *arg1 = (indri::api::QueryEnvironment *) 0 ;
  indri::api::Parameters *arg2 = 0 ;
...
JNIEXPORT jstring JNICALL Java_edu_umass_cs_indri_indriJNI_PonteExpander_1expand(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jobjectArray jarg3) {
  jstring jresult = 0 ;
...
JNIEXPORT void JNICALL Java_edu_umass_cs_indri_indriJNI_delete_1PonteExpander(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  indri::query::PonteExpander *arg1 = (indri::query::PonteExpander *) 0 ;
...
JNIEXPORT jlong JNICALL Java_edu_umass_cs_indri_indriJNI_SWIGRMExpanderUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
...
JNIEXPORT jlong JNICALL Java_edu_umass_cs_indri_indriJNI_SWIGPonteExpanderUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
